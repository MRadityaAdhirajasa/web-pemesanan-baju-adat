...
<div class="container-fluid">
        <ul class="ul-nav">
            ...
            <li class="li-nav-active"><a href="eks_kelola_pesanan.php">Laporan Pesanan</a></li>
            <li class="li-nav"><a href="eks_tracking.php">Tracking</a></li>
            <li class="li-nav"><a href="eks_notifikasi.php">Kirim Notifikasi</a></li>
        </ul>    
    </div>
            ...
            <table class="table align-middle">
                ...
                <?php while ($fetch = mysqli_fetch_assoc($result)) { ?>
                    <tr style="background-color: #3333;">
                        ...
                        <td>
                            <a href="eks_kelola_pesanan_ubah.php?Id_pesanan=<?php echo $fetch['Id_pesanan']; ?>" class="btn btn-dark">Ubah Status</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
