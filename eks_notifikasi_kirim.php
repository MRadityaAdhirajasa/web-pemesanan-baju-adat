...
<div class="container-fluid">
        <ul class="ul-nav">
            <li class="li-nav-2"><a href="eks_home.php"><img src="img/logo.png" alt="logo" width="70" height="50"></a></li>
            <li class="li-nav"><a href="eks_kelola_pesanan.php">Laporan Pesanan</a></li>
            <li class="li-nav"><a href="eks_tracking.php">Tracking</a></li>
            <li class="li-nav-active"><a href="eks_notifikasi.php">Kirim Notifikasi</a></li>
        </ul>    
    </div>
    ...
    <div class="container">
        ...
        <div style="height:500px; background-color: #3333">
            ...
            <div class="d-flex flex-column mb-3" style="margin-top: 10px">
                ...
                <form method="post" action="eks_notifikasi_kirim_query.php" enctype="multipart/form-data">
                ...
                <br><br>
                <label for="notif">Kirim Notifikasi</label><br>
                <input type="text" name="notif">
            </div>
            </div>
